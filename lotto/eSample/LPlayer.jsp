      ...
      <div>
       ...
       try {								
        ...
        conn = DriverManager.getConnection(url, name, password);
         ...
         String query = "Select * from register where accntType= ?";
        ...
        %>
            ...
            <tr>
              ...
              <td style="border: 1px solid;"><%= rs.getInt("phone")%></td>
              <td style="border: 1px solid;"><%= rs.getString("address") %></td>
              <td style="border: 1px solid;"><%= rs.getString("city") %></td>
            </tr>  
