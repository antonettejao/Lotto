  ...
  <div id="body">
        ...
        <div id="content">
		  ...
		  <%
			...
			try {
				...
				//ResultSet rs = stmt.executeQuery("select dateWinPick from WinningPick where emailAdd='strEmail'");
	...
	<%
	 ...
	 int[] anArray = new int[10];
		...
		<form method="post" action="addDraw.jsp">
	...
	<%
		 ...
		 <input id="delay" type="text" name="draw1" value=<%=anArray[0]%> size="3" readonly></p><br/>
		<input id="delay" type="text" name="draw2" value=<%=anArray[1]%> size="3" readonly></p><br/>
		<input id="delay" type="text" name="draw3" value=<%=anArray[2]%> size="3" readonly></p><br/>
		<input id="delay" type="text" name="draw4" value=<%=anArray[3]%> size="3" readonly></p><br/>
		<input id="delay" type="text" name="draw5" value=<%=anArray[4]%> size="3" readonly></p><br/>
		<input id="delay" type="text" name="draw6" value=<%=anArray[5]%> size="3" readonly></p><br/>
		<br/><input type="submit" value="Submit Draw" tabindex="6"/>
		</form>
		...
		<h1>SORRY :(</h1>
							<script language="javascript">
								answer = confirm("No one placed a bet. go back??")
