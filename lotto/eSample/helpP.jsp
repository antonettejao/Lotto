  ...
  <div id="header">
   ...
   <h1> <a href="playerP.jsp"><span>Cyber</span>Lotto</a></h1>
    <ul>
      ...
      <li><a href="helpP.jsp"class="on">help</a></li>
    ...
    <div>
      <div>
        <div id="content">
          ...
          <h3>How to play 6/49</h3>
          <p><strong>Standard Play</strong><br/>1. Select the number of draws you want to play. <br/>2. Pick six numbers from 1 to 49. <br/>3. Click Submit.
          <br/><br/><strong>Lucky Pick</strong><br/>1. Just click the Luck Pick button. <br/>2. Click Submit.
         <p><strong>Rules</strong><br/>1. You must be 18 years old and above to be a member. ONLY members can play this game.<br/> 2. You must be a Filipino and resident of the Philippines.<br/> 3. You must enjoy playing 6/49 Lotto! :)</p>
