...
<%
   ...
   if (cookies != null){
	for(int i = 0; i< cookies.length; i++){
		...
		if(cookies [i].getName().equals(cookieNameA)){
...
<div id="container">
  <div id="header">
    ...
    <ul>
      <li><a href="index.jsp" class="on">home</a></li>
        ...
        <div id="sub">
		 ...
		 <%
			...
			int checkctr = 0;
				...
				String propFile = "C:/Users/Parjao/Desktop/apache-tomcat-6.0.29-windows-x86/apache-tomcat-6.0.29/webapps/exam/dbsource.property";
