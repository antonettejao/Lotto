       ...
       String name = application.getAttribute("name").toString();
        ...
        %>
            ...
            <tr style="border: 1px solid;">
              ...
              <td style="border: 1px solid;">Date: <%= rs.getDate("dateWPick")%></td>
              <td style="border: 1px solid;">First Number: <%= rs.getInt("firstWPick")%></td>
			<td style="border: 1px solid;">Second Number: <%= rs.getInt("secondWPick")%></td>
			<td style="border: 1px solid;">Third Number: <%= rs.getInt("thirdWPick")%></td>
			<td style="border: 1px solid;">Fourth Number: <%= rs.getInt("fourthWPick")%></td>
			<td style="border: 1px solid;">Fifth Number: <%= rs.getInt("fifthWPick")%></td>
			<td style="border: 1px solid;">Sixth Number: <%= rs.getInt("sixthWPick")%></td>
			<td style="border: 1px solid;">Match: <%= rs.getInt("matchPick")%></td>
			<td style="border: 1px solid;">Prize: <%= rs.getInt("prize")%></td>		
