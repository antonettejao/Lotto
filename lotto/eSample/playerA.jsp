    ...
    <div>
      <div>
        <div id="content">
		  ...
		  <center>
		  <br/>
          <h3><a href="CPlayer.jsp"><img class="btn" src="buttons/cpAdmin.gif"></a></h3>
		  <h3><a href="LPlayer.jsp"><img class="btn" src="buttons/player.gif"></a></h3>
		  <h3><a href="CWinner.jsp"><img class="btn" src="buttons/cwAdmin.gif"></a></h3>
		  <h3><a href="PWinner.jsp"><img class="btn" src="buttons/pwAdmin.gif"></a></h3>
		  <h3><a href="auditTrail.jsp"><img class="btn" src="buttons/atAdmin.gif"></a></h3>
          </center>
