    ...
    <div>
      <div>
        <div id="content">
		  ...
		  <center>
          <br/>
		  <h3><a href="manualPick.jsp"><img class="btn" src="buttons/mpPlayer.gif"><a/></h3>
		  <h3><a href="LuckyPick.jsp"><img class="btn" src="buttons/lpPlayer.gif"><a/></h3>
		  <h3><a href="viewPrizes.jsp"><img class="btn" src="buttons/vpPlayer.gif"><a/></h3>
		  </center>
